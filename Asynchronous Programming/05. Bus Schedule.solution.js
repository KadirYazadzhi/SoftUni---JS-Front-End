...
// This function is intended to be initialized on page load.
// Example: let result = solveSolution();
// document.getElementById('depart').addEventListener('click', result.depart);
// document.getElementById('arrive').addEventListener('click', result.arrive);
